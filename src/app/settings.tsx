      ...
      <ScrollView contentInsetAdjustmentBehavior="automatic" style={[styles.screen, { backgroundColor: colors.background }]} contentContainerStyle={styles.content}>
        ...
        <View style={[styles.locationCard, { backgroundColor: colors.surface, borderColor: colors.border, boxShadow: shadow.soft }]}>
          ...
          {permissionStatus === 'denied' || permissionStatus === 'restricted' ? (
            <PressableScale onPress={() => void openLocationSettings()} style={[styles.permissionButton, { backgroundColor: colors.surfaceMuted }]}>
        ...
        <PressableScale onPress={() => setLogoutOpen(true)} style={[styles.logout, { backgroundColor: colors.surfaceGlass, borderColor: colors.border, boxShadow: shadow.soft }]}><Ionicons name="log-out-outline" size={19} color={colors.warm} /><ThemedText variant="headline" style={{ color: colors.warm }}>로그아웃</ThemedText></PressableScale>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  permissionButton: { minHeight: 42, borderRadius: radius.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.xs },
  ...
  logout: { minHeight: 54, borderRadius: radius.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: spacing.xs, borderWidth: StyleSheet.hairlineWidth },
